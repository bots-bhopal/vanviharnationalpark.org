                ...
                <div class="card">
                    <div class="card-header d-flex">
                        <h3 class="card-title my-auto" style="font-size: 18px; font-weight: 600;">
                            {{ __('panel.superadmin-list') }}
                            <span class="badge badge-info pt-1 pb-1 pl-2 pr-2 ml-1" data-toggle="tooltip" data-placement="top" title="{{ __('panel.superadmin-tooltip') }}" style="font-size: 14px; font-weight: 500;">{{ $admins->count() }}</span>
                        </h3>
                        <a class="btn btn-sm btn-primary ml-auto" href="{{route('serveradmin.user.create')}}"><i class="nav-icon fas fa-plus-circle" style="margin-right: 5px;"></i>{{ __('panel.btn-user-add') }}</a>
                    </div>
                    <div class="card-body">
