                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <form action="{{ route('superadmin.document.update', $documents->id) }}" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="description">{{ __('panel.document-description') }}</label>
                                    <textarea class="ckeditor form-control mb-2 @error('description') is-invalid @enderror" rows="5" id="description" name="description">{{ $documents->description }}</textarea>
                                    @error('description')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
