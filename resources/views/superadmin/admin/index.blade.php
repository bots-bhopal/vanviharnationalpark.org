            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-header d-flex">
                        ...
                        <a class="btn btn-sm btn-primary ml-auto" href="{{route('superadmin.user.create')}}"><i class="nav-icon fas fa-plus-circle" style="margin-right: 5px;"></i>{{ __('panel.btn-user-add') }}</a>
                    </div>
                    <div class="card-body">
