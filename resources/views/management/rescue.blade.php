...
@section('title', '- Rescue & Breeding Center')
        ...
        <div class="row">
            ...
            <div class="col-lg-7 col-md-7 col-sm-12">
                <div class="box-title mb-20">
                    <h2>{{ trans('navbar.rescue') }}</h2>
                </div>

                <div class="full-pic">
                    <figure>
                        <img src="{{ asset('public/assets/images/vvnp-imgs/rescue_breeding_center.jpg') }}" alt="">
                    </figure>
                </div>
                ...
                <div class="text-box mt-3">
                    <div class="text-content text-justify">
                        ...
                        <h4>{{ trans('management.rescue-p3') }}</h4>
                        <p>{{ trans('management.rescue-p4') }}</p>
                        <p>{{ trans('management.rescue-p5') }}</p>
