            ...
            <div class="col-lg-7 col-md-7 col-sm-12">
                ...
                <div class="full-pic text-center">
                    <div class="image-block">
                        <div class="images image-box">
                            <figure>
                                <img src="{{ asset('public/assets/images/vvnp-imgs/wild-cafe.jpg') }}" alt="">
                            </figure>
                        </div>
                    </div>
                </div>
                ...
                <div class="text-box mt-3">
                    <div class="text-content text-justify">
                        <p>{{ trans('tourist.cafe-p1') }}</p>
                        <p>{{ trans('tourist.cafe-p2') }}</p>
                        <p>{{ trans('tourist.cafe-p3') }}</p>
                        <p>{{ trans('tourist.cafe-p4') }}</p>
                    </div>
                </div>
