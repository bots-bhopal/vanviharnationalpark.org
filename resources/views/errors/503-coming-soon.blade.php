...
<head>
    ...
    <title>Van Vihar National Park & Zoo | Coming Soon</title>
...
<body>
    <div class="container mt-5">
        <div class="row mb-5">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="title">
                    <h1 class="text-white">
                        <span style="color: #f9c820; text-shadow: 2px 2px 4px #000;">Van </span> <span
                            style="color: #f4edd2; text-shadow: 2px 2px 4px #000;">Vihar National Park & Zoo</span>
                    </h1>
                </div>

                <div class="sub-title mt-5">
                    <h2 class="text-white" style="text-shadow: 2px 2px 4px #000;">
                        Coming Soon
                    </h2>
                </div>
            </div>
        ...
        <div class="row mt-5">
            <div class="col-lg-12 text-center">
                <a href="{{ url('/') }}" class="btn btn-lg btn-outline-aqua" style="font-weight: 700;">LAUNCH <i
                        class="fa fa-rocket" aria-hidden="true" style="font-size: 22px;"></i></a>
            </div>
        </div>
    </div>
    ...
    <script>
        function handleTickInit(tick) {
            ...
            Tick.count.schedule('sunday at 12:00', {
                timezone: '+05:30'
